  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error: setupError, setupIntent } = await stripe.confirmSetup({
        ...
        confirmParams: {
          return_url: `${window.location.origin}/${locale}/dashboard/business/payment/success?type=subscription`,
        },
      });
      ...
      window.location.href = `/${locale}/dashboard/business/payment/success?type=subscription`;
