// app/dashboard/business/overview/components/time-range-chart.tsx
"use client"

import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from "recharts"
import { useTranslations } from "next-intl"
import type { EvaluationTimeRange } from "@/app/api/dashboard/b2b/types"
...
export function TimeRangeChart({ data }: TimeRangeChartProps) {
  const t = useTranslations("dashboard.business.timeRangeChart")
