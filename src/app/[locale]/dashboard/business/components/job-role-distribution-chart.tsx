// app/dashboard/business/overview/components/job-role-distribution-chart.tsx
"use client"

import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { PieChart, Pie, Cell, ResponsiveContainer } from "recharts"
import { useTranslations } from "next-intl"
import type { JobRoleDistribution } from "@/app/api/dashboard/b2b/types"

interface JobRoleDistributionChartProps {
  data: JobRoleDistribution[]
}

const COLORS = ["#9333ea", "#ec4899", "#3b82f6", "#10b981", "#f59e0b", "#ef4444", "#14b8a6", "#8b5cf6"]

export function JobRoleDistributionChart({ data }: JobRoleDistributionChartProps) {
  const t = useTranslations("dashboard.business.jobRoleDistributionChart")
