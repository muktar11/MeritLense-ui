// app/dashboard/indivisual/overview/components/evaluation-trend-chart.tsx
"use client";

import { useLocale, useTranslations } from "next-intl";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { AreaChart, Area, XAxis, YAxis, ResponsiveContainer, Tooltip } from "recharts";
import type { EvaluationTrend } from "@/app/api/dashboard/b2c/types";
...
export function EvaluationTrendChart({ data }: EvaluationTrendChartProps) {
  const t = useTranslations("dashboard.indivisual.evaluationTrendChart");
