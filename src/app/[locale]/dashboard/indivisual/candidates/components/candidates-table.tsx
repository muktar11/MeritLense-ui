  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      {/* Desktop/tablet: full table. Below md, a horizontally-scrolling
          table hides Contact/Job Role/Status/Skills/Actions off-screen with
          no visual hint they exist - the card list below replaces it
          instead of trying to cram the same columns into a narrow
          viewport. */}
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="text-xs text-gray-500">
                          {t("idLabel", { id: candidate.passport_id })}
                        </div>
                      </div>
                    </div>
                  </td>
