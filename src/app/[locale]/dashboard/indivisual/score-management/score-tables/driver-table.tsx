...
export function DriverTable({ candidates, scores, onViewScores }: DriverTableProps) {
  return (
      ...
      <table className="w-full text-sm">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            ...
            <th className="px-4 sm:px-6 py-2 text-left font-semibold text-gray-700">{SCORE_AREA_LABELS.SAFE_DRIVING}</th>
            <th className="px-4 sm:px-6 py-2 text-left font-semibold text-gray-700">{SCORE_AREA_LABELS.ROUTE_PLANNING}</th>
            <th className="px-4 sm:px-6 py-2 text-left font-semibold text-gray-700">{SCORE_AREA_LABELS.VEHICLE_MAINTENANCE}</th>
            <th className="px-4 sm:px-6 py-2 text-left font-semibold text-gray-700">{SCORE_AREA_LABELS.NAVIGATION}</th>
          ...
          {candidates.map((candidate) => {
            ...
            return (
              <tr key={candidate.id} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="px-4 sm:px-6 py-3 text-gray-600">{candidateScore.SAFE_DRIVING || '-'}</td>
                <td className="px-4 sm:px-6 py-3 text-gray-600">{candidateScore.ROUTE_PLANNING || '-'}</td>
                <td className="px-4 sm:px-6 py-3 text-gray-600">{candidateScore.VEHICLE_MAINTENANCE || '-'}</td>
                <td className="px-4 sm:px-6 py-3 text-gray-600">{candidateScore.NAVIGATION || '-'}</td>
